...
Depending on your insurance coverage, all or a portion of your visit might be reimbursed by your insurance company. You will be provided with a “superbill” which is a type of receipt that you can give to your insurance company for reimbursement purposes. Please contact your insurance company directly to determine your specific coverage and complete any necessary paperwork.\n
No shows/rescheduling with less than 24 business hours notice will be charged for the full session.`
    },
    {
        index: 3,
        question:'What are your fees?',
        answer: `Initial consultation (2 sessions, each lasting 60 minutes):\n 
First 60 minute appointment - evaluation including discussion with patient or guardian (if applicable), reviewing medical records and other collateral information: $295\n 
Second 60 minute appointment - evaluation including discussion with patient or guardian (if applicable), treatment recommendations: $295\n 
Follow-up appointment - 20 to 30 minutes including documentation time: $205\n 
Psychotherapy appointment - 45 to 50 minutes with or without medication management: $295\n`,       
    ...
    // {item.answer.split("Follow-up appointments").map((answer, index) => 
    //                                 <>
    //                                 {(index !== 0 && <strong>Follow-up Appointments</strong>)}
    //                                 {answer}
    //                                 </>
